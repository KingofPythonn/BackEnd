...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs",{
    HtmlContent:"<h1>WELCOME TO BAND GENERATOR 🫷<h1>",
...
app.post("/submit", (req, res) => {
  ...
  const random1 = Math.floor(Math.random() * noun.length);
  combine=adj[random]+" "+ noun[random1]
  console.log(combine);
  name=combine
  // const numLetters = adj[Math.floor(Math.random() * adj.length)]+" "+ noun[Math.floor(Math.random() * noun.length)];
